(function () {
    ...
    angular
        .module('devionnAdmin')
        .controller('ProcedimentoController', ProcedimentoController);

    /** @ngInject */
    function ProcedimentoController($mdDialog, $mdPanel, $rootScope, $localStorage, $http, $location) {
        var vm = this;
        var panelRef;
        ...
        vm.confirmaCadastro = function () {
            ...
            $mdDialog.show(confirmDialog).then(function () {
                vm.salvaCadastro(vm.procedimento);
            }, function () {
        ...
        vm.salvaCadastro = function(procedimento) {
            var baseUrl = 'http://localhost:8081';
            var salvar = $http.post(baseUrl + '/ws/usuario/salvar', procedimento);
        ...
        vm.abreCadastro = function () {
            $location.path('/procedimento/cadastro');
        }
